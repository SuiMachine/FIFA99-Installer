//  FIFA 99
//  Modified for FIFA 99 by SuicideMachine
...
begin
	...
	begin
		...
		begin
			if MsgBox('Is there a FIFA 99 CD in your computer? If not, please insert it and press OK.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
